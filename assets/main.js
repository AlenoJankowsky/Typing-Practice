...
generateTextButton.addEventListener('click',async function() {
  await generateText(paragraphWithText);
...
document.addEventListener('keydown', function(event) {
  if (generateTextButtonIsClicked) {
    handleKeyDownEvent(event, paragraphWithText, statsText, todayStatsText, charArray, charIndex, seconds, userKeyTypeCount, userMistakesCount, amountOfSets);
  }
});
